...
@section('content')
    <div class="container">
        ...
        <div class="row d-flex justify-content-center">
            <div id="post-blog" class="col-xl-3 col-lg-5 col-md-11">
            ...
            <div id="post-blog" class="col-xl-3 col-lg-5 col-md-11">
                <div id="content-imag-blog">
                    <img id="imag-blog" src="https://free4kwallpapers.com/uploads/originals/2020/06/05/a-bust-with-a-skull-mask-and-neon-lights-oc-wallpaper.jpg" alt="">
                </div>
                <div id="text-post">
                    <h3 id="text-blog">TITLE 1</h3>
                    <hr id="bar-blog">
